...
async function _createEmbeddedEntity(collection, data, options) {
  if (collection === "OwnedItem") {
    ...
    oldCreateEmbeddedEntity.bind(this)(collection, data, options)
  }
}
...
async function _deleteEmbeddedEntity(collection, data, options) {
  if (collection === "OwnedItem") {
    ...
    oldDeleteEmbeddedEntity.bind(this)(collection, data, options)
  }
}
...
// const oldUpdateEmbeddedEntity = Item5e.prototype.updateEmbeddedEntity;
async function _updateEmbeddedEntity(collection, data, options) {
// Item5e.prototype.updateEmbeddedEntity = async function(collection, data, options) {
  if (collection === "OwnedItem") {
    this.updateOwnedItem(data, options)
  } else {
    oldUpdateEmbeddedEntity.bind(this)(collection, data, options)
  }
}
...
Hooks.once("init", () => {
  console.log("Itemcontainers initialisation")
  oldUpdateEmbeddedEntity = Item5e.updateEmbeddedEntity;
  Item5e.prototype.updateEmbeddedEntity = _updateEmbeddedEntity;
  oldCreateEmbeddedEntity = Item5e.createEmbeddedEntity;
  Item5e.prototype.createEmbeddedEntity = _createEmbeddedEntity;
  oldDeleteEmbeddedEntity = Item5e.deleteEmbeddedEntity;
