...
//      if (!this.canAdd(item)) return false;
    ...
    async _toggleEquipped(event) {
      await this.object.setFlag("itemcollection", "equipped.value", 
        this.object.getFlag("itemcollection", "fixedWeight.value") || !this.object.getFlag("itemcollection", "equipped.value"));
        this._updateWeight();
    };
