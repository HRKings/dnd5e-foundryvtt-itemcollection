...
//    await this.deleteOwnedItem(id);
  ...
  async _itemConvertToGold(event) {
    ...
    console.log(`gold conversion ${this.item.name} ${itemData.name} ${goldValue}`)
    ...
    console.log(`setting new GP to ${currency.gp}`)
    console.log(currency);
    console.log(this.item);

    if (this.item.isOwned) {
      console.log("Udating owned item ")
...
Item.prototype.updateParent = async function(contents) {
  // console.log(`item ${this.name} is owned by ${this.actor.name}`);
  // console.log({"_id": this._id, "flags.itemcollection.contents": contents});
  if (this.actor.data.flags.itemcollection || this.actor.isToken) {
    // console.log(`actor ${this.actor.name} has itemcollection flags`)
...
Item.prototype.updateOwnedItem = async function(itemChanges, options) {
  ...
  console.log("Update owned item ")
  console.log(itemChanges._id); console.log(itemData); console.log(itemChanges);
  itemChanges = expandObject(itemChanges);
  console.log("diff is ")
  console.log(diffObject(itemData, expandObject(itemChanges)));
